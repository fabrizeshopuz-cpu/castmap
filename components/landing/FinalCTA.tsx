...
export function FinalCTA({ onDemo }: { onDemo: () => void }) {
  return (
    <section id="aloqa" className="px-4 py-20 sm:px-6 lg:px-8">
      <div className="glass-panel light-sweep mx-auto grid max-w-7xl items-center gap-10 overflow-hidden rounded-lg border-[#D4AF37]/20 p-6 shadow-[0_0_80px_rgba(212,175,55,0.16)] sm:p-8 lg:grid-cols-[0.95fr_1.05fr] lg:p-12">
        <Reveal>
        ...
        <Reveal className="relative min-h-[360px] [perspective:1200px]">
          ...
          <motion.div
            className="glass-panel absolute left-1/2 top-12 w-[min(420px,82vw)] -translate-x-1/2 rounded-[24px] p-7 shadow-[0_45px_100px_rgba(2,6,23,0.55),0_0_70px_rgba(212,175,55,0.16)] lg:[transform:perspective(1200px)_rotateX(14deg)_rotateY(-12deg)]"
            animate={{ y: [0, -9, 0] }}
          ...
          <motion.div
            className="glass-panel absolute bottom-10 right-4 w-24 rounded-[28px] p-3 shadow-[0_28px_80px_rgba(2,6,23,0.55)] sm:right-20"
